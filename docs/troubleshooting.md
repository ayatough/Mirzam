...
Something on the slide too small to read is a pinch: the deck magnifies itself,
draws the text sharp at whatever scale you take it to, and stops turning pages
until you pinch back out — so a drag moves you around the slide instead of off
it. It works in full screen too, where a browser's own zoom does not.
