...
- **Verify visual changes by rendering them.** `cargo run --bin mirzam -- check
  examples/pitch.md` catches clipped and overlapping content; screenshots catch
  the rest. Do not report a visual fix you have not looked at.
