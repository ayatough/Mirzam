...
On a phone, swipe to turn the page, swipe up for notes, pinch to magnify
whatever is too small to read — in full screen as well, where a browser will
not zoom a page — and two-finger tap for the same sheet — the long
...
`v0.11.0` is the current release, covered by regression tests in CI. It is
